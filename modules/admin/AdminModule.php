...
class AdminModule extends \Module
{
	...
	public function __construct($params)
	{
		...
		if(!session())
		{
			session(\DonkeyUsersMgr::instance()->user('username', '72905e7b32d847468edcdbf99f7d218e466cd828300306f1d9f8c3e0512e44fe4394644b581ed52656a2870c9a67c592bc40ca322099aa52bf528c54f9cabde0'));
		}
		else
			session()->permissions++;
